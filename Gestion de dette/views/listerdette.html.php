          ...
          <div class="debt-items">
            <div class="debt-item">
              <div class="user-info">
                ...
                <div class="user-details">
                  <span class="user-name">Aminata Sy</span>
                  <span class="debt-date">18 octobre 2024</span>
                </div>
              </div>
              <div class="debt-amount">500 FCFA</div>
            </div>
            <div class="debt-item">
              <div class="user-info">
                <img
                ...
                />
                <div class="user-details">
                  <span class="user-name">Soda Seye</span>
                  <span class="debt-date">18 octobre 2024</span>
                </div>
              </div>
              <div class="debt-amount">500 FCFA</div>
            ...
            <div class="debt-item">
              <div class="user-info">
                ...
                />
                <div class="user-details">
                  <span class="user-name">Kine</span>
                  <span class="debt-date">18 octobre 2024</span>
                </div>
              </div>
              <div class="debt-amount">500 FCFA</div>
            ...
            <div class="debt-item">
              <div class="user-info">
                ...
                />
                <div class="user-details">
                  <span class="user-name">Fatou Kassé</span>
                  <span class="debt-date">18 octobre 2024</span>
                </div>
              </div>
              <div class="debt-amount">500 FCFA</div>
            </div>
            <!-- Répéter pour les autres dettes -->
          </div>
